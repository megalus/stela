...
@pre_load
def pre_load_test(options: StelaCutOptions) -> Dict[Any, Any]:
    return {"stele": "rosetta", "project": {"secret": "pre_load_secret"}, "pre_key": 1}


@custom_load
def custom_load_test(
    data: Mapping[Any, Any], options: StelaCutOptions
) -> Dict[Any, Any]:
    return {
...
@post_load
def post_load_test(data: Mapping[Any, Any], options: StelaCutOptions) -> Dict[Any, Any]:
    return {
        "stele": "merneptah",
