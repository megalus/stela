...
def test_default_lifecycle(full_lifecycle, stela_default_settings, monkeypatch):
    ...
    """
    test_options = StelaOptions(**stela_default_settings).get_config()
    test_stela = Stela(options=test_options)
